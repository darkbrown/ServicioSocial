...
<head>
    ...
    <title id="tituloPagina" name="tituloPagina">SS: Coordinador</title>
...
<body>
    ...
    <span class="navbar-toggler-icon"></span>
        ...
        <a href="<?php echo base_url()?>index.php/Coordinador" class="navbar-brand">LIS | SERVICIO SOCIAL</a>
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item ">
                    <a href="<?php echo base_url()?>index.php/Alumnos" class="nav-link">Lista Alumnos</a>
                </li>
                <li class="nav-item ">
                    <a href="<?php echo base_url()?>index.php/Responsables" class="nav-link">Lista Responsables</a>
                </li>
            </ul>
        </div>
    </nav>