<div class="container-fluid">
    ...
    <div class="container col-md-5 border-0" align="center">
                <label for="matriculaAnterior">Matrícula</label>
                <input type="text"  disabled class="form-control" id="matriculaAnterior" name="matriculaAnterior" value="<?php echo $matricula;?>" maxlength="9"
                        required>
                </div> 
        <div class="form-row">
...
<script type="text/javascript" src="<?php echo base_url();?>js/EditarMatricula.js"></script>